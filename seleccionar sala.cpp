...
void Miercoles(){
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        if (disponibles<10)
            {
            cout<<"     | "<<" Miercoles " << espacio (6, 6)<< arrayL[i]<< espacio(1, 6)<< arrayLp[1]<<espacio (1, 11)<<i+1<<espacio(4,10)<<peliculas[j]<<espacio(peliculas[j].size(),39)<<" disp:"<<disponibles<<"/25 ("<<lleno<<")|\n";
            }
            else if (disponibles>10)
            {
            cout<<"     | "<<" Miercoles " << espacio (6, 6)<< arrayL[i]<< espacio(1, 6)<< arrayLp[1]<<espacio (1, 11)<<i+1<<espacio(4,10)<<peliculas[j]<<espacio(peliculas[j].size(),38)<<" disp:"<<disponibles<<"/25 ("<<lleno<<")|\n";
            }
...
void Viernes(){
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        if (disponibles<10)
            {
            cout<<"     | "<<" Viernes " << espacio (4, 6)<< arrayL[i]<< espacio(1, 6)<< arrayLp[3]<<espacio (1, 11)<<i+1<<espacio(4,10)<<peliculas[j]<<espacio(peliculas[j].size(),39)<<" disp:"<<disponibles<<"/25 ("<<lleno<<")|\n";
            }
            else if (disponibles>10)
            {
            cout<<"     | "<<" Viernes " << espacio (4, 6)<< arrayL[i]<< espacio(1, 6)<< arrayLp[3]<<espacio (1, 11)<<i+1<<espacio(4,10)<<peliculas[j]<<espacio(peliculas[j].size(),38)<<" disp:"<<disponibles<<"/25 ("<<lleno<<")|\n";
            }
...
void Sabado(){
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        if (disponibles<10)
            {
            cout<<"     | "<<" Sabado " << espacio (3, 6)<< arrayL[i]<< espacio(1, 6)<< arrayLp[3]<<espacio (1, 11)<<i+1<<espacio(4,10)<<peliculas[j]<<espacio(peliculas[j].size(),39)<<" disp:"<<disponibles<<"/25 ("<<lleno<<")|\n";
            }
            else if (disponibles>10)
            {
            cout<<"     | "<<" Sabado " << espacio (3, 6)<< arrayL[i]<< espacio(1, 6)<< arrayLp[3]<<espacio (1, 11)<<i+1<<espacio(4,10)<<peliculas[j]<<espacio(peliculas[j].size(),38)<<" disp:"<<disponibles<<"/25 ("<<lleno<<")|\n";
            }
...
void Domingo(){
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        if (disponibles<10)
            {
            cout<<"     | "<<" Domingo " << espacio (4, 6)<< arrayL[i]<< espacio(1, 6)<< arrayLp[3]<<espacio (1, 11)<<i+1<<espacio(4,10)<<peliculas[j]<<espacio(peliculas[j].size(),39)<<" disp:"<<disponibles<<"/25 ("<<lleno<<")|\n";
            }
            else if (disponibles>10)
            {
            cout<<"     | "<<" Domingo " << espacio (4, 6)<< arrayL[i]<< espacio(1, 6)<< arrayLp[3]<<espacio (1, 11)<<i+1<<espacio(4,10)<<peliculas[j]<<espacio(peliculas[j].size(),38)<<" disp:"<<disponibles<<"/25 ("<<lleno<<")|\n";
            }
        cout << "     _________________________________________________________________________________________________________________\n";
    }
    cout<<endl<<endl;
...
{   
    ...
    cout<<"usted a seleccionado la sala#"<<peli;
